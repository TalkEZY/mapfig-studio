<?PHP
	...
	if(!$error) {
		...
		updateMap($mapId, $user['id'], 'name', $name);
		updateMap($mapId, $user['id'], 'height', $height);
		updateMap($mapId, $user['id'], 'width', $width);
		updateMap($mapId, $user['id'], 'zoom', $zoom);
		updateMap($mapId, $user['id'], 'password', $password);
		updateMap($mapId, $user['id'], 'mapcenter', $center);
		updateMap($mapId, $user['id'], 'showsidebar', $showsidebar);
	}
