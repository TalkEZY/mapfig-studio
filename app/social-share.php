                              ...
                              <tbody>
								<?PHP foreach($maps as $map) { ?>
                                 <tr>
                                    ...
                                    <td><?=$map['zoom']?></td>
                                    <td>
										<span class='st_sharethis_large' st_url="<?=BASEURL?>app/map-view.php?mapid=<?=$map['id']?>" st_image="<?=BASEURL?>app/img/share/default.png" st_title="<?=$map['name']?>" displayText='ShareThis'></span>
										<span class='st_facebook_large' st_url="<?=BASEURL?>app/map-view.php?mapid=<?=$map['id']?>" st_image="<?=BASEURL?>app/img/share/facebook.png" st_title="<?=$map['name']?>" displayText='Facebook'></span>
										<span class='st_twitter_large' st_url="<?=BASEURL?>app/map-view.php?mapid=<?=$map['id']?>" st_image="<?=BASEURL?>app/img/share/twitter.png" st_title="<?=$map['name']?>" displayText='Tweet'></span>
										<span class='st_linkedin_large' st_url="<?=BASEURL?>app/map-view.php?mapid=<?=$map['id']?>" st_image="<?=BASEURL?>app/img/share/linkedin.png" st_title="<?=$map['name']?>" displayText='LinkedIn'></span>
										<span class='st_pinterest_large' st_url="<?=BASEURL?>app/map-view.php?mapid=<?=$map['id']?>" st_image="<?=BASEURL?>app/img/share/pinterest.png" st_title="<?=$map['name']?>" displayText='Pinterest'></span>
										<span class='st_email_large' st_url="<?=BASEURL?>app/map-view.php?mapid=<?=$map['id']?>" st_image="<?=BASEURL?>app/img/share/email.png" st_title="<?=$map['name']?>" displayText='Email'></span>
									</td>
                                 </tr>
								<?PHP } ?>
                              </tbody>
