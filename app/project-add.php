<?PHP
	...
	$error   = "";
	$success = "";
	if(strlen($_SESSION['response']['project-add']['error']) > 0){
		$error = '<div ng-show="authMsg" class="alert alert-danger text-center ng-binding">'.$_SESSION['response']['project-add']['error'].'</div>';
	}
	else if(strlen($_SESSION['response']['project-add']['success']) > 0){
		$success = '<div ng-show="authMsg" class="alert alert-success text-center ng-binding">'.$_SESSION['response']['project-add']['success'].'</div>';
	}
	unset($_SESSION['response']['project-add']['error']);
	unset($_SESSION['response']['project-add']['success']);
                  ...
                  <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                        <div class="table-responsive">
							<form action="processor/project-add/index.php" method="post">
								<table class="table">
								  <tbody>
									 <tr>
										<td>Project Name</td>
