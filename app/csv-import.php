<?PHP
	...
	if(strlen($_SESSION['response']['csv-import']['error']) > 0){
		$error = '<div ng-show="authMsg" class="alert alert-danger text-center ng-binding">'.$_SESSION['response']['csv-import']['error'].'</div>';
	}
	unset($_SESSION['response']['csv-import']['error']);
                  ...
                  <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                        <div class="table-responsive">
							<form action="processor/csv-import/index.php" method="post" enctype="multipart/form-data">
								<table class="table">
								  <tbody>
									 <tr>
										<td>Choose File</td>
									 ...
									 <tr style="display:none;">
										<td>Delimiter (One Character, Don't change if you're not sure)</td>
										<td><input type="text" class="form-control" name="delimiter" value=","/></td>
									 </tr>
									 <tr style="display:none;">
										<td>Enclosure (One Character, Don't change if you're not sure)</td>
										<td><input type="text" class="form-control" name="enclosure" value='"'/></td>
									 </tr>
									 <tr style="display:none;">
										<td>Escape (One Character, Don't change if you're not sure)</td>
										<td><input type="text" class="form-control" name="escape" value="\"/></td>
									 </tr>
								  </tbody>
								</table>
								<br>
								<div class="pull-right">
									<input type="hidden" name="import" value="inport"/>
									<button class="btn btn-success"><i class="fa fa-arrow-down"></i> Import</button>
								</div>
							</form>
                        </div>
                     </div>
