...
<head>
   <meta charset="utf-8">
   <title>View Maps (Project : <?=$project['name']?>)</title>
   ...
   <div class="wrapper">
      ...
      <section>
         ...
         <div class="content-wrapper">
            <h3>View Maps (Project : <?=$project['name']?>)
               <small></small>
            </h3>
            <div class="">
               <div class="col-lg-12">
								...
								<?PHP foreach($maps as $map) { ?>
                                 <tr>
                                    ...
                                    <td>
										...
										<textarea style="display:none;" id="iframe_<?=$map['id']?>"><iframe src='<?=BASEURL?>app/map-view.php?mapid=<?=$map['id']?>' height="<?=$map['height']?>" width="<?=$map['width']?>" style="height:<?=$map['height']?>;width:<?=$map['width']?>;border:0;"></iframe></textarea>
