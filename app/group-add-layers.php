<?PHP
	...
	else if(strlen($_SESSION['response']['group-add-layers']['success']) > 0){
...
<head>
   <meta charset="utf-8">
   <title>Assign Layers to Group</title>
   ...
   <div class="wrapper">
      ...
      <section>
		 ...
		 <div class="content-wrapper">
			<h3>Assign Layers to Group (<?=$group['name']?>)
               <small></small>
            </h3>
            <div class="">
               <div class="col-lg-12">
                  <div class="panel panel-default">
                     <div class="panel-heading">Group Name : <?=$group['name']?></div>
					 <div class="col-lg-12"><?=$error.$success?></div>
                     <div class="panel-body">
                        <div class="table-responsive">
							<form action="processor/group-add-layers/index.php" method="post">
