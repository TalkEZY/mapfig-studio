<?PHP
	...
	else if(strlen($_SESSION['response']['group']['success']) > 0){
								  ...
								  <tbody>
									<?PHP foreach($group as $g) { ?>
									 <tr>
										...
										<td><?=$g['name']?></td>
										<td>
											<a href="group-edit.php?id=<?=$g['id']?>" class="btn btn-sm btn-info"><i class="fa fa-edit"></i> Edit</a>
											<a href="group-add-layers.php?id=<?=$g['id']?>" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Add Layers</a>
											<a href="layers.php?groupid=<?=$g['id']?>" class="btn btn-sm btn-default"><i class="fa fa-eye"></i> View layers</a>
											<a href="group.php?id=<?=$g['id']?>" class="btn btn-sm btn-danger"><i class="fa fa-remove"></i> Delete</a>
										</td>
									 </tr>
									<?PHP } ?>
								  </tbody>
