...
(function(window, document, $, undefined){
  ...
  function toggleMenuItem($listItem) {
    ...
    //removeFloatingNav();
	$('.sidebar-subnav.nav-floating').closest('.sidebar-subnav-container').animate({
		opacity: 0,
		left: "+=20"
	}, 5000, function() {
		$('.sidebar-subnav.nav-floating').closest('.sidebar-subnav-container').remove();
	});

    var ul = $listItem.children('.sidebar-subnav-container');
