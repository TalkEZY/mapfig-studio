...
| -------------------------------------------------------------------*/
	...
	$randomFolder = generateRandomString().time();
	$config['img_path'] = '/app/mapplates/images/'.$randomFolder; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
	
	shell_exec("mkdir ../../../../../../mapplates/images/".$randomFolder." 2>&1");
