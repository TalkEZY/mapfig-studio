<?PHP
	...
	else if(strlen($_SESSION['response']['group-edit']['success']) > 0){
                  ...
                  <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                        <div class="table-responsive">
							<form action="processor/group-edit/index.php" method="post">
								<input type="hidden" name="id" value="<?=$group['id']?>">
								<table class="table">
								  <tbody>
									 <tr>
										<td>Group Name</td>
										<td><input type="text" name="name" class="form-control" value="<?=$group['name']?>"></td>
									 </tr>
								  </tbody>
								</table>
								<br>
