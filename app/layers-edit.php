<?PHP
	...
	else if(strlen($_SESSION['response']['layers-edit']['success']) > 0){
            ...
            <div class="">
               <div class="col-lg-12">
                  <div class="panel panel-default">
                     <div class="panel-heading">Edit Base Layers</div>
					 <div class="col-lg-12"><?=$error.$success?></div>
                     <div class="panel-body">
                        <div class="table-responsive">
							<form action="processor/layers-edit/index.php" method="post">
								<input type="hidden" name="id" value="<?=$layer['id']?>">
								<table class="table">
								  <tbody>
									 <tr>
										<td>Layer Name</td>
										<td><input type="text" name="name" class="form-control" value="<?=$layer['name']?>"></td>
									 </tr>
									 <tr>
										<td>Layer URL</td>
										<td><input type="text" name="url" class="form-control" value="<?=$layer['url']?>"></td>
									 </tr>
									 <tr>
										<td>Key</td>
										<td><input type="text" name="lkey" class="form-control" value="<?=$layer['lkey']?>"></td>
									 </tr>
									 <tr>
										<td>Access Token</td>
										<td><input type="text" name="accesstokey" class="form-control" value="<?=$layer['accesstokey']?>"></td>
									 </tr>
									 <tr>
										<td>Attribution</td>
										<td><input type="text" name="attribution" class="form-control" value="<?=htmlspecialchars($layer['attribution'])?>"></td>
									 </tr>
								  </tbody>
								</table>
								<br>
