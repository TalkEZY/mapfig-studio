								  ...
								  <tbody>
									<?PHP foreach($maps as $map) { ?>
									 <tr>
										...
										<td><?=$map['zoom']?></td>
										<td>
											<a href="csv-edit.php?id=<?=$map['id']?>" class="btn btn-sm btn-info" title="Edit"><i class="fa fa-edit"></i> Edit in Table</a> 
											<a href="map-edit.php?id=<?=$map['id']?>" class="btn btn-sm btn-info" title="Edit"><i class="fa fa-edit"></i> Edit on Map</a> 
											<a href="csv.php?id=<?=$map['id']?>" class="btn btn-sm btn-danger" title="Delete Map"><i class="fa fa-remove"></i> </a>
										</td>
									 </tr>
									<?PHP } ?>
								  </tbody>
